...
const ShowAllProductsUnderCategory = (props) => {
    ...
    const loadAllProducts = () => {
        ProductServices.getAllProductsByCatId(catId).then(res => {
                    ...
                    <div className="col center mt-0">
                        <div className="card-mb-3 mt-0 content">
                            ...
                            <div className="card-body ">
                                ...
                                <div className="row ">
                                    <h2><button className="btn btn-primary" onClick={() => addNewProduct(catId)} >Add New Product</button></h2>
                                </div>
                                <div className="row" >
...
export default ShowAllProductsUnderCategory;
