            ...
            <nav className="navbar navbar-expand-lg navbar-mainbg ">
...

                {
                    st === true && (<Dropdown>
                        ...
                        <Dropdown.Menu className="super-colors">
                            ...
                            <Dropdown.Item href="/update-address"><i class="far fa-address-book"></i> Update Address</Dropdown.Item>
                            <Dropdown.Item href="/order-history"><i class="fab fa-jedi-order"></i> Order History</Dropdown.Item>
                            <Dropdown.Divider />
                            <Dropdown.Item href="/sign-out"><i class="fas fa-sign-out-alt"></i> Sign Out</Dropdown.Item>
                        </Dropdown.Menu>
                    </Dropdown>
                    )}
                <button
                ...
                <div
                    ...
                    <ul className="navbar-nav ml-auto">
                        ...
                        {st === true &&
                            <li className="nav-item" >
                                <Link className="nav-link text-light" to="/logout-page" exact>
